...
addon.spellsDB = {
    ...
    [271] = { -- Ambushes the furthest enemy at range, damaging them for $s1 Nature damage for three turns.
        ...
        event = "beforeAttack",
        buffName = "Ambush",
        persistAfterDeath = true, -- yup, this actually keeps doing damage after the caster dies. Wow. Ardenweald Grovetender[3][548HP] killed Boneweave Ambusher[9][275HP]., Boneweave Ambusher[9][275HP]'s Ambush dealt 158 Nature to Ardenweald Grovetender[3][548HP]. Boneweave Ambusher[9][0HP]'s Ambush dealt 158 Nature to Ardenweald Grovetender[3][390HP].
    },
