...
L["ALWAYS_SHOW_EXTENDED_INFO"] = "總是顯示角色職責分數"
L["ALWAYS_SHOW_EXTENDED_INFO_DESC"] = "按下一個快捷鍵（shift/ctrl/alt）在提示中顯示玩家的角色職責分數。如果您啟用此選項，提示將永遠顯示角色類型分數。"
...
L["KEYSTONE_COMPLETED_10"] = "+10-14（鑰石征服者）"
L["KEYSTONE_COMPLETED_15"] = "+15（鑰石王）"
L["KEYSTONE_COMPLETED_5"] = "+5-9 （鑰石探險者）"
L["LEGION_MAIN_SCORE"] = "軍臨天下本尊分數"
...
L["OUTDATED_DATABASE_S"] = "|cffFFFFFF%s|r的數據已經過期|cffFF6666%d|r天。請更新此插件已顯示更精確的大秘分數。"
