...
L["Frame"] = "框架"
L["Friends List"] = "好友列表"
L["From time to time you should compare your ElvUI version against the most recent version on our website or the Tukui client."] = "您应该时不时将您的 ElvUI 版本与我们网站或 Tukui 客户端上的最新版本进行比较。"
L["G"] = "公会"
L["Ghost"] = "鬼魂"
...
L["LOGIN_MSG"] = ("欢迎使用*ElvUI|r 版本*%.2f|r，输入*/ec|r 访问游戏内配置菜单。如果您需要技术支持，您可以访问我们的 https://www.tukui.org 或加入我们的 Discord：https://discord.gg/xFWcfgE"):gsub('*', E.InfoColor)
...
L["Need help? Join our Discord: https://discord.gg/xFWcfgE"] = "需要帮助？加入我们的 Discord：https://discord.gg/xFWcfgE"
