...
L["Check to disable error reporting."] = true
...
L["Error in %s: %s -- details: %s"] = "錯誤的%s: %s的 --細節: %s" -- Needs review
L["Exclude list"] = "排除列表"
L["Filter"] = "過濾"
...
L["No error reports"] = "沒有錯誤報告" -- Needs review
...
L["Error in %s: %s -- details: %s"] = "错误出现于%s：%s --详情:%s" -- Needs review
L["Exclude list"] = "排除列表"
L["Filter"] = "过滤"
...
L["No error reports"] = "没有错误报告" -- Needs review
